...
<head>
	...
	<link rel="stylesheet" href="{{url('public/template/css/animations.css')}}">
	<link rel="stylesheet" href="{{url('public/template/css/font-awesome5.css')}}">
	<link rel="stylesheet" href="{{url('public/template/css/icomoon.css')}}">
	<link rel="stylesheet" href="{{url('public/template/css/main.css')}}" class="color-switcher-link">
	<link rel="stylesheet" href="{{url('public/template/css/shop.css')}}" class="color-switcher-link">
	<script src="{{url('public/template/js/vendor/modernizr-2.6.2.min.js')}}"></script>

	<!--[if lt IE 9]>
		<script src="{{url('public/template/js/vendor/html5shiv.min.js')}}"></script>
		<script src="{{url('public/template/js/vendor/respond.min.js')}}"></script>
...
<body>
	...
	<div class="modal" tabindex="-1" role="dialog" aria-labelledby="search_modal" id="search_modal">
		...
		<div class="widget widget_search">
			<form method="get" class="searchform search-form" action="{{url('/')}}">
						...
						<div class="row d-flex align-items-center justify-content-center">
							<div class="col-xl-3 col-md-4 col-12 text-center">
								<a href="index.html" class="logo">
									<img src="{{url('public/template/images/logo.png')}}" alt="">
									<span class="d-flex flex-column">
										<span class="logo-text color-darkgrey">Hastec</span>
...
@yield('content')
    ...
    <script src="{{url('public/template/js/compressed.js')}}"></script>
	<script src="{{url('public/template/js/main.js')}}"></script>
	{{-- <script src="{{url('public/template/js/switcher.js')}}"></script> --}}
