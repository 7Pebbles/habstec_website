...
@section('content')
        ...
        <div class="flexslider">
            <ul class="slides">
                <li class="ds cover-image">
                    <img src="{{ url('public/template/images/slide01.jpg') }}" alt="img">
                ...
                <li class="ds cover-image">
                    <img src="{{ url('public/template/images/slide02.jpg') }}" alt="img">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="intro_layers_wrapper">
                ...
                <li class="ds cover-image">
                    <img src="{{ url('public/template/images/slide03.jpg') }}" alt="img">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="intro_layers_wrapper">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 text-center">
                    ...
                    <p>
                        Duis aute irure dolor in reprehenderit in voluptate velit esse cillum doloreu fugiat nulla pariatur.
                        Excepteur sint occaecat cupidatat non proident,
                        sunt in culpa qui officia deserunt mollit animest laborum sed ut perspiciatis unde omnis iste natus
    ...
    <section class="ls  s-py-xl-160 s-py-lg-130 s-py-md-90 s-py-60 text-sm-left text-center container-px-0">
        <div class="cover-image s-cover-left">
            <img src="{{ url('public/template/images/services/service1.jpg') }}" alt="01">
        </div>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-12 col-12 col-lg-6">
                    <div class="content-center">
                        ...
                        <p>
                            Cillum doloreu fugiat nulla pariatur excepteur si occaecat cupdatat non proident sunt culpaq
                            officia deserunt mollt animest laborum sed perspiciatis unde omnis iste natus errosit voluptatem
                            accuantium doloremque laudantium totam.
                        </p>
                        <div class="divider-45 hidden-below-lg"></div>
                        <div class="divider-30 hidden-above-lg"></div>
    ...
    <section class="ls  s-py-xl-160 s-py-lg-130 s-py-md-90 s-py-60 text-sm-left text-center container-px-0">
        <div class="cover-image s-cover-right">
            <img src="{{ url('public/template/images/services/service2.jpg') }}" alt="01">
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-12 col-lg-6">
                    <div class="content-center">
                        ...
                        <div class="divider-30 hidden-above-lg"></div>
                        <p>
                            Rem aperiam, eaque ipsa qillo inventore veritatis etquasi architecto beatae vitae dicta sunt
                        ...
                        <div class="shortcode-widget-area">
                            <div class="widget widget_mailchimp">
                                ...
                                <form class="signup" action="https://html.modernwebtemplates.com/">
                                    ...
                                    <input id="mailchimp_email88" name="email" type="email"
                                        class="form-control mailchimp_email has-placeholder" placeholder="Email">
    ...
    <section class="ls  s-py-xl-160 s-py-lg-130 s-py-md-90 s-py-60 text-sm-left text-center container-px-0">
        <div class="cover-image s-cover-left">
            <a href="{{ url('public/template/images/services/service3.jpg') }}" class="photoswipe-link side-video"
                data-width="800" data-height="800" data-iframe="https://www.youtube.com/embed/GhthHC0s38A"></a>
            <img src="{{ url('public/template/images/services/service3.jpg') }}" alt="01">
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-12 col-lg-6">
                ...
                <div class="col-xs-12 col-12 col-lg-6">
                    <div class="content-center">
                        ...
                        <p>
                            ...
                            sit amet, consectetur, adipisci velit, sed quia non numquam. Watch our presentation:
                        </p>
                ...
                <div class="col-12">
                    ...
                    <div class="row isotope-wrapper portfolio masonry-layout c-mb-30" data-filters=".gallery-filters">
                        ...
                        <div class="col-xl-4 col-sm-6 business news">
                            ...
                            <div class="vertical-item item-gallery content-absolute text-center ds">
                                <div class="item-media">
                                    <img src="{{ url('public/template/images/gallery/full/01.jpg') }}" alt="img">

                                </div>
                                <div class="item-content">
                                    <div class="links-wrap">
                                        <a class="link-zoom photoswipe-link" title=""
                                            href="{{ url('public/template/images/gallery/full/01.jpg') }}"></a>
                        ...
                        <div class="col-xl-4 col-sm-6 innovations corporate">
                            <div class="vertical-item item-gallery content-absolute text-center ds">
                                <div class="item-media">
                                    <img src="{{ url('public/template/images/gallery/full/02.jpg') }}" alt="img">
                                </div>
                                <div class="item-content ">
                                    <div class="links-wrap">
                                        <a class="link-zoom photoswipe-link" title=""
                                            href="{{ url('public/template/images/gallery/full/02.jpg') }}"></a>
                                        <a class="link-anchor" title="" href="gallery-single.html"></a>
                                    </div>
                                    <h6>
                        ...
                        <div class="col-xl-4 col-sm-6 entertainment news innovations">
                            <div class="vertical-item item-gallery content-absolute text-center ds">
                                <div class="item-media">
                                    <img src="{{ url('public/template/images/gallery/full/03.jpg') }}" alt="img">

                                </div>
                                <div class="item-content ">
                                    <div class="links-wrap">
                                        <a class="link-zoom photoswipe-link" title=""
                                            href="{{ url('public/template/images/gallery/full/03.jpg') }}"></a>
                                        <a class="link-anchor" title="" href="gallery-single.html"></a>
                                    </div>
                        ...
                        <div class="col-xl-4 col-sm-6 business entertainment">
                            <div class="vertical-item item-gallery content-absolute text-center ds">
                                <div class="item-media">
                                    <img src="{{ url('public/template/images/gallery/full/04.jpg') }}" alt="img">

                                </div>
                                <div class="item-content ">
                                    <div class="links-wrap">
                                        <a class="link-zoom photoswipe-link" title=""
                                            href="{{ url('public/template/images/gallery/full/04.jpg') }}"></a>
                                        <a class="link-anchor" title="" href="gallery-single.html"></a>
                                    </div>
                        ...
                        <div class="col-xl-4 col-sm-6 innovations corporate">
                            <div class="vertical-item item-gallery content-absolute text-center ds">
                                <div class="item-media">
                                    <img src="{{ url('public/template/images/gallery/full/05.jpg') }}" alt="img">
                                </div>
                                <div class="item-content">
                                    <div class="links-wrap">
                                        <a class="link-zoom photoswipe-link" title=""
                                            href="{{ url('public/template/images/gallery/full/05.jpg') }}"></a>
                                        <a class="link-anchor" title="" href="gallery-single.html"></a>
                                    </div>
                        ...
                        <div class="col-xl-4 col-sm-6 entertainment news corporate">
                            <div class="vertical-item item-gallery content-absolute text-center ds">
                                <div class="item-media">
                                    <img src="{{ url('public/template/images/gallery/full/06.jpg') }}" alt="img">
                                </div>
                                <div class="item-content">
                                    <div class="links-wrap">
                                        <a class="link-zoom photoswipe-link" title=""
                                            href="{{ url('public/template/images/gallery/full/06.jpg') }}"></a>
                                        <a class="link-anchor" title="" href="gallery-single.html"></a>
                                    </div>
                    ...
                    <div id="accordion01" role="tablist">
                        <div class="card">
                            ...
                            <div id="collapse01" class="collapse show" role="tabpanel"
                                ...
                                <div class="card-body">
                                    Our team has been gelpingclients throughout the country for 10 years lorem ipsum dolor
                        ...
                        <div class="col-lg-4  col-sm-6  ">
                            <a href="#">
                                <div class="bordered text-center p-xl-50 p-20 rounded">
                                    <img src="{{ url('public/template/images/partners/01.png') }}" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-4 col-sm-6  ">
                            <a href="#">
                                <div class="bordered text-center p-xl-50 p-20 rounded">
                                    <img src="{{ url('public/template/images/partners/02.png') }}" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-4 col-sm-6  ">
                            <a href="#">
                                <div class="bordered text-center p-xl-50 p-20 rounded">
                                    <img src="{{ url('public/template/images/partners/03.png') }}" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-4 col-sm-6  ">
                            <a href="#">
                                <div class="bordered text-center p-xl-50 p-20 rounded">
                                    <img src="{{ url('public/template/images/partners/04.png') }}" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-4 col-sm-6  ">
                            <a href="#">
                                <div class="bordered text-center p-xl-50 p-20 rounded">
                                    <img src="{{ url('public/template/images/partners/05.png') }}" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-4 col-sm-6  ">
                            <a href="#">
                                <div class="bordered text-center p-xl-50 p-20 rounded">
                                    <img src="{{ url('public/template/images/partners/06.png') }}" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-4 col-sm-6  ">
                            <a href="#">
                                <div class="bordered text-center p-xl-50 p-20 rounded">
                                    <img src="{{ url('public/template/images/partners/07.png') }}" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-4 col-sm-6  ">
                            <a href="#">
                                <div class="bordered text-center p-xl-50 p-20 rounded">
                                    <img src="{{ url('public/template/images/partners/08.png') }}" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-4 col-sm-6  ">
                            <a href="#">
                                <div class="bordered text-center p-xl-50 p-20 rounded">
                                    <img src="{{ url('public/template/images/partners/09.png') }}" alt="">
                                </div>
                            </a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="divider-30 hidden-above-lg"></div>
                    <div class="owl-carousel team-carousel" data-center="false" data-nav="false" data-margin="30"
                        data-loop="true" data-responsive-lg="3" data-responsive-md="3" data-responsive-sm="2"
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between flex-wrap ">
                        <div class="simple-counter">
                            <h3 class="special-heading counter-wrap">
                                <span class="counter color-main thin big" data-from="0" data-to="22"
                        ...
                        <div class="simple-counter">
                            <h3 class="special-heading counter-wrap">
                                <span class="counter color-main thin big" data-from="0" data-to="65"
                                    data-speed="1800">0</span>
                            </h3>
                            <p class="special-heading bold color-darkgrey">
                                <span>
                        ...
                        <div class="simple-counter">
                            <h3 class="special-heading counter-wrap">
                                <span class="counter color-main thin big" data-from="0" data-to="15"
                                    data-speed="1800">0</span>
                    ...
                    <div class="shortcode-posts row tiled-layout c-gutter-30 c-mb-30">
                            ...
                            <article
                                ...
                                <div class="item-content">
                                                ...
                                                <span class="date">
                                                    <a href="blog-%40%40type.html" rel="bookmark">
                                                        <time class="published entry-date"
                                                            datetime="2019-04-09T12:23:09+00:00">20.03.2019</time>
                                                    </a>
                                                </span>
                                                <span class="author vcard">
                                                    <a class="url fn n" href="blog-%40%40type.html"
                                                        rel="author"><span>by</span> Admin</a>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="entry-content">
                                        <p>
                                            Tempor incididunt labore dolmagna aliqua eniminim veniam quis nostrud
                        ...
                        <div class=" smallitem col-xl-6 col-lg-7">
                            <article
                                ...
                                <div class="item-media post-thumbnail">
                                    <a href="blog-single-%40%40type.html">
                                        <img src="{{ url('public/template/images/blog/square/02.jpg') }}" alt="img">
                                    </a>
                                </div><!-- .post-thumbnail -->
                                <div class="item-content">
                                    <header class="entry-header">
                            ...
                            <article
                                ...
                                <div class="item-media post-thumbnail">
                                    <a href="blog-single-%40%40type.html">
                                        <img src="{{ url('public/template/images/blog/square/03.jpg') }}" alt="img">
                                    </a>
                                </div><!-- .post-thumbnail -->
                                <div class="item-content">
                                    <header class="entry-header">
